						...
						<div class="col-12 m-b30 mb-lg-0 d-flex border-shop">
							<div class="card shop-card shadow-none mb-lg-0 w-100">
								<div class="card-body">
									...
									<div>
										<label class="label-title m-b10">reminder number</label>
										<input type="tel" name="phone_number" class="form-control form-control-solid"
											placeholder="+91 9878459856" pattern="^\+?[1-9]\d{1,14}$"
											title="Please enter a valid international phone number (e.g., +1234567890)"
											value="<?php echo $reminder ? esc_attr($reminder->user_number) : ''; ?>"
											required>
									</div>
								</div>
							</div>
