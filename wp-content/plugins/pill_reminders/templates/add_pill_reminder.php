...
function add_pill_reminder()
{
	...
	if ($edit_id > 0) {
		...
		if (!$reminder) {
			...
			if ($reminder->user_id != get_current_user_id() && !current_user_can('manage_options')) {
				echo '<div class="alert alert-danger">You don\'t have permission to edit this reminder.</div>';
				$reminder = null;
			}
		}
	}
						...
						<div class="col-12 m-b30 mb-lg-0 d-flex border-shop">
							<div class="card shop-card shadow-none mb-lg-0 w-100">
								<div class="card-body">
									...
									<?php if ($reminder && isset($reminder->id)): ?>
										<input type="hidden" name="edit_id" value="<?php echo esc_attr($reminder->id); ?>">
											...
											<div class="row align-items-center">
												<div class="col-lg">
													<div>
														...
														<input name="medicine_name" class="form-control form-control-solid"
														...
														<div class="col-lg-6">
															<select class="form-select form-control-solid"
																...
																<option value="1-Year" <?php echo ($reminder && $reminder->duration_type == '1-Year') ? 'selected' : ''; ?>>1
																	Year</option>
																<option value="Life-time" <?php echo ($reminder && $reminder->duration_type == 'Life-time') ? 'selected' : ''; ?>>Life time</option>
															</select>
														</div>
														<div class="col-lg-6">
															<div
													...
													<div class="row align-items-end">
														...
														<div class="col-lg-6">
															<input class="form-control-solid form-control-lg" type="time"
																name="instruction_time" value="<?php echo $reminder ? esc_attr($reminder->instruction_time) : ''; ?>">
														</div>
													</div>
												</div>
											</div>
												...
												<div class="col-lg-6">
													<div class="row align-items-center">
														<div class="col-lg-6">
															...
															<input name="from_date" class="form-control form-control-solid"
														...
														<div class="col-lg-6">
															...
															<input name="to_date" class="form-control form-control-solid"
																placeholder="Type here" type="date"
